/* 
   ...
   Course: CS 581 
   Homework #: 5
   Instructions to compile the program: nvcc hw5_GPU_Shared.cu -o hw5_GPU_Shared 
   Instructions to run the program: ./hw5_GPU_Shared <matrix_size> <max_generations> <output_directory>
*/
